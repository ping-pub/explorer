...
<template>
  <div class="bg-white dark:bg-[#212121] rounded text-sm">
          ...
          <td class="w-full">
            <div>
              ...
              <div v-if="item.content"
                class="bg-[#212121] text-[#9c6cff] dark:bg-gray-600 dark:text-gray-300 inline-block rounded-full px-2 py-[1px] text-xs mb-1">
