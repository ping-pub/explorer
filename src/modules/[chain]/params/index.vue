...
<template>
  <div class="overflow-hidden">
    <!-- Chain ID -->
    <div class="bg-[#ffffff] dark:bg-[#222222] px-4 pt-3 pb-4 rounded">
      ...
      >
        <div
          ...
          :key="index"
          class="rounded-sm bg-[#f3f4f6] dark:bg-[#303030] px-4 py-2"
        >
    ...
    <!-- Application Version -->
    <div class="bg-[#ffffff] dark:bg-[#222222] px-4 pt-3 pb-4 rounded-sm mt-6">
