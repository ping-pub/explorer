  ...
  <div>
    <div class="bg-vector-bg px-4 pt-3 pb-4 rounded shadow">
      ...
      <div class="mockup-code bg-base-200 my-2">
        <pre
          data-prefix="1"><code class="text-gray-800 ">&lt;script type="module" src="https://unpkg.com/ping-widget@latest/dist/ping-widget.js"&gt;</code></pre>
      </div>
    </div>
    <div class="bg-vector-bg my-5 px-4 pt-3 pb-4 rounded shadow">
      ...
      <div class="mt-4">
        ...
        <div class="mockup-code bg-base-200 my-2">
          ...
          <pre
            data-prefix=">"><code  class="text-gray-800 ">&lt;ping-connect-wallet chain-id="{{ chainId }}" hd-path="{{ hdPath }}"/&gt;</code></pre>
        </div>

        <span class="text-base"> 2. {{ $t('widget.text_3') }}</span>
        <div class="mockup-code bg-base-200 my-2">
          <pre
            data-prefix=">"><code class=" text-gray-800 ">&lt;ping-token-convert chain-name="{{ chainName }}" endpoint="{{ endpoint }}" hd-path="{{ hdPath }}"/&gt;</code></pre>
          <pre
            data-prefix=">"><code class="text-gray-800 ">&lt;label for="PingTokenConvert" class="btn btn-sm"&gt;Buy {{ chainName.toUpperCase() }}&lt;/label&gt;</code></pre>
        </div>
      </div>
    </div>
  </div>
