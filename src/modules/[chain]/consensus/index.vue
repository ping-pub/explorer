  ...
  <div>
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div class="bg-vector-bg px-4 py-3 rounded shadow flex justify-between items-center">
    ...
    <!-- update -->
    <div class="bg-vector-bg p-4 rounded shadow" v-if="roundState['height/round/step']">
