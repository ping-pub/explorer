            ...
            <div class="mt-4">
                ...
                <div class="mockup-code bg-base-200 my-2 gap-4">
                    <div v-for="it in checklist">
                        <pre><code class="text-gray-800 ">{{ it.title }}: </code>{{ it.status ? '✅' : '❌' }} </pre>
                    </div>
                ...
                <div class="mockup-code bg-base-200 my-2">
                    <pre data-prefix=">"><code class=" text-gray-800 "> Faucet Address: {{ faucet }} </code></pre>
                    <pre
                        data-prefix=">"><code class="text-gray-800 "> Balances: {{ format.formatTokens(balances) }} </code></pre>
                </div>
            </div>
        </div>
