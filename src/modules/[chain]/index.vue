  ...
  <div>
    <div v-if="coinInfo && coinInfo.name" class="bg-base-100 shadow">
        ...
        <div class="col-span-2 md:col-span-1">
          ...
          <div>
            <div class="dropdown dropdown-hover w-full">
              <label>
                <div class="bg-gray-100 dark:bg-[#384059] flex items-center justify-between px-4 py-2 cursor-pointer">
                  <div>
      ...
      <div class="mx-4 flex flex-wrap items-center">
        <div v-for="tag in coinInfo.categories" class="mr-2 mb-4 text-xs bg-gray-100 dark:bg-[#384059] px-3 py-1">
          {{ tag }}
        </div>
      </div>
    </div>
    ...
    <div class="bg-base-100 mt-4 shadow">
      ...
      <div class="grid grid-cols-3 gap-4 px-4 pb-6 mt-4">
        ...
        <label for="send" class="btn btn-primary btn-outline text-white"
          @click="dialog.open('send', {}, updateState)">{{ $t('account.btn_send') }}</label>
        <label for="delegate" class="btn btn-primary text-white" @click="dialog.open('delegate', {}, updateState)">{{
