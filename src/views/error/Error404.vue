      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 287.89 400">
        <defs>
          <linearGradient id="a" x1="1.28" y1="164.53" x2="258.89" y2="164.53" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="0.02" stop-color="#fcd403" />
            <stop offset="0.22" stop-color="#e6be19" />
            <stop offset="0.43" stop-color="#d7ad29" />
            <stop offset="0.68" stop-color="#cea432" />
            <stop offset="1" stop-color="#cba135" />
          </linearGradient>
          <linearGradient id="b" x1="24.75" y1="163.06" x2="282.35" y2="163.06" xlink:href="#a" />
          <linearGradient id="c" x1="76" y1="99.07" x2="212.99" y2="233.78" xlink:href="#a" />
          <linearGradient id="d" x1="56.95" y1="324.83" x2="259.85" y2="424.78" gradientUnits="userSpaceOnUse">
            <stop offset="0" stop-color="gold" />
            <stop offset="1" stop-color="#cba135" />
          </linearGradient>
        </defs>
        <title>Neobase-gold-logo</title>
        <path
          d="M55.26,124v136.5H31V31.22L6.82,7V284.68H147.49l-24.23-24.22H79.49v-78L99.9,202.85l3.8,3.8,5.37,5.37,96.87,96.88H103.7l23.71,24.22h137Z" />
        <path
          d="M239.45,214.7V78.2h24.23V307.44l24.21,24.22V54H147.22L171.45,78.2h43.78v78L88.77,29.76H191L167.3,5.54h-137Z" />
        <polygon points="242.27 248.4 243.42 281.4 52.44 90.27 51.29 57.26 242.27 248.4" />
        <path
        ...
        <path
          ...
          style="fill:url(#d)" />
        <path d="M78.38,347.51v6.38h-31v-6.38Zm0,40.22h-31V364.46h31v6.32H53.73v10.57H78.38Z" style="fill:url(#d)" />
        <path
        ...
        <path
          ...
          style="fill:url(#d)" />
        <path d="M280.77,347.51v6.38h-31v-6.38Zm0,40.22h-31V364.46h31v6.32H256.11v10.57h24.66Z" style="fill:url(#d)" />
      </svg>
    </b-link>
