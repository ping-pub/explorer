  ...
  <div class="bg-gray-100 dark:bg-[#171d30]">
    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/allora testnet" class="flex items-center">
          <img class="w-[120px] h-[120px]" src="../../assets/logo.svg" />
          <h1 class="flex-1 ml-3 mt-1 text-xl font-semibold text-[#0DAB6B]">
            explorer
          </h1>
        </RouterLink>
        <div
