<template>
    <div>
        <a href="https://cosmos.network" target="_blank"
            ...
            <img src="https://ping.pub/logos/cosmos.svg" class="w-6 h-6 mr-3" />
        ...
        <a href="https://osmosis.zone" target="_blank"
            class="py-2 px-4 flex items-center cursor-pointer hover:bg-gray-100 dark:hover:bg-[#373f59]">
            <img src="https://ping.pub/logos/osmosis.jpg" class="w-6 h-6 mr-3" />
            <div class="text-sm capitalize flex-1 text-gray-600 dark:text-gray-200">
                Osmosis
            </div>
        </a>
        <a href="https://celestia.org" target="_blank"
            class="py-2 px-4 flex items-center cursor-pointer hover:bg-gray-100 dark:hover:bg-[#373f59]">
            <img src="https://ping.pub/logos/celestia.png" class="w-6 h-6 mr-3" />
            <div class="text-sm capitalize flex-1 text-gray-600 dark:text-gray-200">
                Celestia
            </div>
        </a>
